* BML - Bridge Bidding Markup Language
  ...
  supposed to be backwards compatible unless mentioned otherwise. For better
  distinguishing both BML versions I may refer to BML 1 (Erik's version) and BML 2
  (this version).
  ...
  - HTML :: Outputs a .htm-file which can be used on the web. Use bml2html.py.

  - LaTeX :: Outputs a .tex-file which can be converted to a pdf,
             using LaTeX. Use bml2latex.py.
